/**
 * @file      drv.NullDefinitions.hpp
 * @author    Sergey Baigudin, sergey@baigudin.software
 * @copyright 2023, Sergey Baigudin, Baigudin Software
 *
 * @brief Driver global definitions.
 */
#ifndef DRV_NULLDEFINITIONS_HPP_
#define DRV_NULLDEFINITIONS_HPP_
 ...
 */
#ifndef EOOS_GLOBAL_DRV_NUMBER_OF_NULLS
    /**
     * @brief Number of Null driver resources that must be form 1 to infinity.
     */
    #define EOOS_GLOBAL_DRV_NUMBER_OF_NULLS (1)
#endif
...
#endif // DRV_NULLDEFINITIONS_HPP_
